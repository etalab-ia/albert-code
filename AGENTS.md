...
- **Provider Albert** : `provider.albert.npm = "@ai-sdk/openai-compatible"`, `options.baseURL = "https://albert.api.etalab.gouv.fr/v1"`, `options.apiKey = "{env:ALBERT_API_KEY}"`, `models` listant `deepseek-v4-flash`, `qwen3-coder-30b-A3b-instruct` et `mistral-medium-3-5-128b`. Puis `model = "albert/deepseek-v4-flash"`, `small_model = "albert/deepseek-v4-flash"`.
...
- Ne pas utiliser de modèle Albert autre que `deepseek-v4-flash` (défaut), `qwen3-coder-30b-A3b-instruct` (spécialisé code) et `mistral-medium-3-5-128b` (alternatif, en panne côté Albert au 26/08/2026).
