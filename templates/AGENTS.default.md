...
- À chaque commit, joindre en dernière ligne (précédée d'une ligne vide) le trailer `Co-Authored-By: Albert Code (<id-modèle>) <albert-code@users.noreply.github.com>`, avec l'id canonique Albert du modèle courant.
